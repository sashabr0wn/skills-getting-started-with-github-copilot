...
activities = {
    ...
    "Art Club": {
        "description": "Explore drawing, painting, and mixed media projects in a creative studio environment",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["isabella@mergington.edu", "harper@mergington.edu"]
    },
    "Drama Club": {
        "description": "Act, improvise, and stage performances with opportunities to build confidence and teamwork",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["ella@mergington.edu", "grace@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Solve challenging math problems and prepare for competitions and team challenges",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["lucas@mergington.edu", "amelia@mergington.edu"]
    },
    "Science Club": {
        "description": "Conduct experiments and explore STEM topics through hands-on projects and discussions",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
